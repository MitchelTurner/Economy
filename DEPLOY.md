...
| `RATE_LIMIT_UPLOAD` | 60 / min / IP+household | `POST /receipts/upload-url\|register\|manual\|:id/reextract\|confirm\|reopen`, `DELETE /receipts/:id` |
...
| `RATE_LIMIT_HOUSEHOLD` | 20 / min / user+household | household export/wipe/transfer/leave/remove/rename; budgets/alerts CRUD + check; insights generate/dismiss/restore; `POST /prices/index/rollup` |
