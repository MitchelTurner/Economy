...
| `RATE_LIMIT_UPLOAD` | 60 / min / IP+household | `POST /receipts/upload-url`, `POST /receipts/:id/reextract` |
...
| `RATE_LIMIT_HOUSEHOLD` | 20 / min / user+household | `GET /household/export`, `DELETE /household`, `POST /household/transfer` |
