...
Return ONLY valid JSON matching the required schema. Do not clean or rewrite line item text — keep rawText verbatim as printed.
Money fields are integer cents. currency must be "USD".`;
